...
static struct clk_alpha_pll gpll2_out_aux2 = {
	.offset = 0x4a000,
	.regs = clk_alpha_pll_regs[CLK_ALPHA_PLL_TYPE_DEFAULT],
	.clkr = {
		.enable_reg = 0x45000,
...
/* about 1208.6MHz configuration */
static const struct alpha_pll_config gpll3_out_main_config = {
	.l = 63,
...
//BIT(5) appears to be some MST/DIFF signal no idea what it even mean
...
//BIT(7) appears to be output invert its even wildier now
...
static struct clk_fixed_factor gpll6_out_main_div = {
	.mult = 1,
	.div = 2,
	.hw.init = &(struct clk_init_data){
		.name = "gpll6_out_main_div",
		.parent_names = (const char *[]){
			"gpll6",
		},
		.num_parents = 1,
...
static const struct parent_map gcc_bi_tcxo_gpll0_gpll0div2_2_map[] = {
	{ P_BI_TCXO, 0 },
	{ P_GPLL0, 1 },
	{ P_GPLL0_DIV2, 2 },
};

static const struct parent_map gcc_bi_tcxo_gpll0_gpll0div2_4_map[] = {
	{ P_BI_TCXO, 0 },
	{ P_GPLL0, 1 },
	{ P_GPLL0_DIV2, 4 },
};

static const char * const gcc_bi_tcxo_gpll0_gpll0div2_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll0_out_aux",
};
...
static const char * const gcc_apc_droop_detector_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll4",
};
...
static struct clk_rcg2 apc0_droop_detector_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_names = gcc_apc_droop_detector_names,
		.num_parents = ARRAY_SIZE(gcc_apc_droop_detector_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static struct clk_rcg2 apss_ahb_clk_src = {
	...
	.enable_safe_config = true,
	.parent_map = gcc_bi_tcxo_gpll0_gpll0div2_4_map,
	.clkr.hw.init = &(struct clk_init_data) {
...
static struct clk_rcg2 blsp1_qup1_i2c_apps_clk_src = {
	...
	.enable_safe_config = true,
	.parent_map = gcc_bi_tcxo_gpll0_gpll0div2_2_map,
	.clkr.hw.init = &(struct clk_init_data) {
...
static const char * const gcc_byte_names[] = {
	"bi_tcxo",
...
static struct clk_rcg2 byte0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "byte0_clk_src",
		.parent_names = gcc_byte_names,
		.num_parents = ARRAY_SIZE(gcc_byte_names),
		.ops = &clk_byte2_ops,
...
static const char * const gcc_gp_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll6",
	"gpll0_out_aux",
...
static struct clk_rcg2 camss_gp0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_names = gcc_gp_names,
		.num_parents = ARRAY_SIZE(gcc_gp_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_cci_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll0_out_aux",
	"sleep",
...
static struct clk_rcg2 cci_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "cci_clk_src",
		.parent_names = gcc_cci_names,
		.num_parents = ARRAY_SIZE(gcc_cci_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_cpp_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll6",
	"gpll2",
...
static struct clk_rcg2 cpp_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "cpp_clk_src",
		.parent_names = gcc_cpp_names,
		.num_parents = ARRAY_SIZE(gcc_cpp_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_csi_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll2",
	"gpll0_out_aux",
...
static struct clk_rcg2 csi0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "csi0_clk_src",
		.parent_names = gcc_csi_names,
		.num_parents = ARRAY_SIZE(gcc_csi_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_csip_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll4",
	"gpll2",
...
static struct clk_rcg2 csi0p_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "csi0p_clk_src",
		.parent_names = gcc_csip_names,
		.num_parents = ARRAY_SIZE(gcc_csip_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
			[VDD_LOW_SVS] = 66670000,
			[VDD_SVS] = 133330000,
			[VDD_SVS_PLUS] = 200000000,
...
static const char * const gcc_esc_vsync_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
};
...
static struct clk_rcg2 esc0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "esc0_clk_src",
		.parent_names = gcc_esc_vsync_names,
		.num_parents = ARRAY_SIZE(gcc_esc_vsync_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_jpeg0_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll6",
	"gpll0_out_aux",
...
static struct clk_rcg2 jpeg0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "jpeg0_clk_src",
		.parent_names = gcc_jpeg0_names,
		.num_parents = ARRAY_SIZE(gcc_jpeg0_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_mclk_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll6",
	"gpll0_out_aux",
...
static struct clk_rcg2 mclk0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "mclk0_clk_src",
		.parent_names = gcc_mclk_names,
		.num_parents = ARRAY_SIZE(gcc_mclk_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_mdp_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll6",
	"gpll0_out_aux",
...
static struct clk_rcg2 mdp_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "mdp_clk_src",
		.parent_names = gcc_mdp_names,
		.num_parents = ARRAY_SIZE(gcc_mdp_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_pclk_names[] = {
	"bi_tcxo",
...
static struct clk_rcg2 pclk0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "pclk0_clk_src",
		.parent_names = gcc_pclk_names,
		.num_parents = ARRAY_SIZE(gcc_pclk_names),
		.ops = &clk_pixel_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_sdcc1_ice_core_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll6",
	"gpll0_out_aux",
...
static struct clk_rcg2 sdcc1_ice_core_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_names = gcc_sdcc1_ice_core_names,
		.num_parents = ARRAY_SIZE(gcc_sdcc1_ice_core_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_sdcc_apss_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll4",
	"gpll0_out_aux",
...
static struct clk_rcg2 sdcc1_apps_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_names = gcc_sdcc_apss_names,
		.num_parents = ARRAY_SIZE(gcc_sdcc_apss_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_usb30_mock_utmi_names[] = {
	"bi_tcxo",
	"gpll6",
	"gpll6_out_main_div",
	"gpll0_out_main",
...
static struct clk_rcg2 usb30_mock_utmi_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_names = gcc_usb30_mock_utmi_names,
		.num_parents = ARRAY_SIZE(gcc_usb30_mock_utmi_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_usb3_aux_names[] = {
	"bi_tcxo",
	"sleep",
};
...
static struct clk_rcg2 usb3_aux_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_names = gcc_usb3_aux_names,
		.num_parents = ARRAY_SIZE(gcc_usb3_aux_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const char * const gcc_vcodec0_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll6",
	"gpll2",
...
static struct clk_rcg2 vcodec0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		...
		.parent_names = gcc_vcodec0_names,
		.num_parents = ARRAY_SIZE(gcc_vcodec0_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
			[VDD_LOW_SVS] = 114290000,
			[VDD_SVS] = 228570000,
			[VDD_SVS_PLUS] = 310000000,
			[VDD_NOMINAL] = 360000000,
...
static const char * const gcc_vfe_names[] = {
	"bi_tcxo",
	"gpll0_out_main",
	"gpll6",
	"gpll4",
...
static struct clk_rcg2 vfe0_clk_src = {
	...
	.clkr.hw.init = &(struct clk_init_data) {
		.name = "vfe0_clk_src",
		.parent_names = gcc_vfe_names,
		.num_parents = ARRAY_SIZE(gcc_vfe_names),
		.ops = &clk_rcg2_ops,
		.vdd_class = &vdd_cx,
		.num_rate_max = VDD_NUM,
		.rate_max = (unsigned long[VDD_NUM]) {
...
static const struct qcom_cc_desc gcc_msm8953_desc = {
	...
	.hwclks = gcc_msm8953_hws,
	.num_hwclks = ARRAY_SIZE(gcc_msm8953_hws),
...
subsys_initcall(gcc_msm8953_init);
...
//todo rotator shit
struct clk_hw *mdss_msm8953_hws[] = {
